...
function fancythemes_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'color_settings', array(
			'title'    => __( 'Colors', 'good' ),
			'priority' =>41,
	) );

	$wp_customize->get_section('colors')->panel = 'color_settings';


	/* Section : Layout Setting
	---------------------------------*/
	$wp_customize->add_section( 'layout', array(
			'title'    => __( 'Layout Setting', 'good' ),
			'priority' => 34,
	) );
	...
	---------------------------------*/
	$wp_customize->add_section( 'main_sidebar_colors', array(
			'title'    => __( 'Header Colors', 'good' ),
			'priority' => 37,
	...
	$wp_customize->add_section( 'content_colors', array(
			'title'    => __( 'Main Content Colors', 'good' ),
			'priority' => 39,
			'panel'    => 'color_settings',
	) );

	$wp_customize->add_section( 'secondary_sidebar_colors', array(
			'title'    => __( 'Secondary Sidebar Colors', 'good' ),
			'priority' => 40,
			'panel'    => 'color_settings',
	) );
	...
	$wp_customize->add_section( 'typography', array(
			'title'    => __( 'Typography Setting', 'good' ),
			'priority' => 42,
	) );
	...
	$wp_customize->add_section( 'footer', array(
			'title'    => __( 'Footer Setting', 'good' ),
			'priority' => 43,
	) );

}

add_action( 'customize_register', 'fancythemes_customize_register' );


/**
 * List of customizer settings
 */
function fancythemes_customize_items( $settings ) {

	$default_color_options = array(
		'main_sidebar_background_color' => '#ffffff',
		'main_sidebar_color' => '#000000',
		'main_sidebar_link_color' => '#ff0000',
		//'main_sidebar_link_hover' => '#222222',
		'main_sidebar_border_color' => '#dddddd',
		'main_sidebar_container_border_color' => '#dddddd',
		'main_sidebar_search_border_color' => '#dddddd',
		'content_background_color' => '#ffffff',
		'content_color' => '#222222',
		'content_link_color' => '#ff0000',
		'content_meta_color' => '#bbbbbb',
		'content_border_color' => '#dddddd',
		'content_container_border_color' => '#ffffff',
		'content_widget_title_color' => '#bbbbbb',
		'content_widget_title_border_color' => '#dddddd',
		'secondary_sidebar_background_color' => '#000000',
		'secondary_sidebar_color' => '#ffffff',
		'secondary_sidebar_meta_color' => '#666666',
		'secondary_sidebar_link_color' => '#ffffff',
		'secondary_sidebar_link_hover_color' => '#ffffff',
		'secondary_sidebar_border_color' => '#222222',
		'container_border_color' => '#dddddd',
		'heading_font' => 'Source_Sans_Pro__400',
		'heading_font_style' => 'normal',
		'heading_font_weight' => '400',
		'heading_font_transform' => 'none',
		'body_font' => 'Lora__400,700',
		'meta_font' => 'Lora__400,700',
		'meta_font_style' => 'normal',
		'meta_font_weight' => '400',
		'meta_font_transform' => 'none',
		'menu_font' => 'Lora__400,700',
		'menu_font_style' => 'normal',
		'menu_font_weight' => '400',
		'menu_font_transform' => 'none',
		'widget_title_font' => 'Source_Sans_Pro__400',
		'widget_title_font_style' => 'normal',
		'widget_title_font_weight' => '400',
		'widget_title_font_transform' => 'uppercase',
	);
	...
	$settings[] = array(
		'default' => false,
		'id' => 'recent_posts_hide',
		'label'    => __( 'Hide the default recent posts on homepage', 'good' ),
	...
	$settings[] = array(
		...
		'label' => __('Do not show posts if home with these categories', 'good'),
		'section' => 'post_setting',
		'control' => 'select',
		'choices'  => fancythemes_taxonomy_array(),
	);
	...
	$settings[] = array(
		...
		'id' => 'footer_credit',
		'control' => 'textarea',
		'label' => __('Credit text on footer', 'good'),
		'section' => 'footer',
	);
	...
	$settings[] = array(
		'default' => '',
		'sanitize_callback' => 'fancythemes_sanitize_text',
		'id' => 'footer_script',
		'control' => 'textarea',
		'label' => __('Add aditional script, please do not include <script> tag.', 'good'),
		'section' => 'footer',
	);
	...
	$settings[] = array(
		...
		'label'    => __( 'Sticky navigation', 'good' ),
		'section'  => 'layout',
		'priority' => 1,
		'control'     => 'checkbox',
	);
	...
	$settings[] = array(
		'default' => false,
		'id' => 'layout_text_align',
		'label'    => __( 'Center aligned content text', 'good' ),
		'section'  => 'layout',
		'priority' => 2,
		'control'     => 'checkbox',
	);
	...
	/* Section : Main Sidebar Colors
	---------------------------------*/

	$settings[] = array(
		'default' => $default_color_options['main_sidebar_background_color'],
		'transport' => 'postMessage',
		'id' => 'main_sidebar_background_color',
		'control' => 'color',
		'label'   => __( 'Main sidebar background color', 'good' ),
		'section' => 'main_sidebar_colors',
		'priority' => 4,
		'apply_css' => array (
			array(
				'selector' => '#page:before, #main-sidebar, #main-navigation, #main-navigation ul li:hover > .sub-menu',
	...
	$settings[] = array(
		'default' => $default_color_options['main_sidebar_color'],
		'transport' => 'postMessage',
		'id' => 'main_sidebar_color',
		'control' => 'color',
		'label'   => __( 'Main sidebar color', 'good' ),
		'section' => 'main_sidebar_colors',
		'priority' => 5,
		'apply_css' => array (
			array(
				'selector' => '#main-sidebar, #main-sidebar a:hover, #main-navigation ul li a, #main-sidebar #searchform #s, #main-navigation .expand-button',
				'property' => 'color',
			),
			array(
				'selector' => '#main-search ::-webkit-input-placeholder',
				'property' => 'color',
			),
			array(
				'selector' => '#main-search :-moz-placeholder',
				'property' => 'color',
			),
			array(
				'selector' => '#main-search ::-moz-placeholder',
			...
			array(
				'selector' => '#main-search :-ms-input-placeholder',
				'property' => 'color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['main_sidebar_link_color'],
		'transport' => 'postMessage',
		'id' => 'main_sidebar_link_color',
		'control' => 'color',
		'label'   => __( 'Main sidebar link color', 'good' ),
		'section' => 'main_sidebar_colors',
		'priority' => 5,
		'apply_css' => array (
			array(
			...
			array(
				'selector' => '#main-navigation .current-menu-item a:after',
				'property' => 'background-color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['main_sidebar_border_color'],
		'transport' => 'postMessage',
		'id' => 'main_sidebar_border_color',
		'control' => 'color',
		'label'   => __( 'Main sidebar borders color', 'good' ),
		'section' => 'main_sidebar_colors',
		'priority' => 6,
		'apply_css' => array (
			array(
				'selector' => '#main-search, #main-navigation .sub-menu li a',
				'property' => 'border-bottom-color',
			),
			array(
				'selector' => '#main-navigation .sub-menu',
	...
	$settings[] = array(
		'default' => $default_color_options['main_sidebar_container_border_color'],
		'transport' => 'postMessage',
		'id' => 'main_sidebar_container_border_color',
		'control' => 'color',
		'label'   => __( 'Main sidebar container borders color', 'good' ),
		'section' => 'main_sidebar_colors',
		'priority' => 6,
		'apply_css' => array (
			array(
				'selector' => '#page:before, #main-navigation',
				'property' => 'border-color',
			),
			array(
	...
	$settings[] = array(
		'default' => $default_color_options['main_sidebar_search_border_color'],
		'transport' => 'postMessage',
		'id' => 'main_sidebar_search_border_color',
		'control' => 'color',
		'label'   => __( 'Main sidebar search box borders color', 'good' ),
		'section' => 'main_sidebar_colors',
		'priority' => 6,
		'apply_css' => array (
			array(
	...
	$settings[] = array(
		...
		'control' => 'color',
		'label'   => __( 'Main content background color', 'good' ),
		'section' => 'content_colors',
		'priority' => 1,
		'apply_css' => array (
			array(
				'selector' => '#primary, .page-navigation, #breadcrumbs, #primary .nav-meta, #primary .category-meta, #comments, #primary .widget-title span, #reply-title span, #site-footer, #main-content:before, #share-post li a',
				'property' => 'background-color',
			),
			array(
				'selector' => '.single-meta div div:before, #primary input[type="button"], #primary input[type="reset"], #primary input[type="submit"], #primary button, #primary .button, #primary .load-more a, #primary input[type="button"]:hover, #primary input[type="reset"]:hover, #primary input[type="submit"]:hover, #primary button:hover, #primary .button:hover, #primary .load-more a:hover',
				'property' => 'color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['content_color'],
		'transport' => 'postMessage',
		'id' => 'content_color',
		'control' => 'color',
		'label'   => __( 'Main content text color', 'good' ),
		'section' => 'content_colors',
		'priority' => 2,
		'apply_css' => array (
			array(
				'selector' => 'a:hover, #primary, #primary .entry-title a, .popular-posts article .home-thumb:after, #primary input, #primary select, #primary textarea,  #site-footer, #share-post li a',
				'property' => 'color',
			),
			array(
				'selector' => '#primary input[type="button"]:hover, #primary input[type="reset"]:hover, #primary input[type="submit"]:hover, #primary button:hover, #primary .button:hover, #primary .load-more a:hover',
				'property' => 'background-color',
			),
			array(
				'selector' => '.load-more a:hover, .load-more a:focus, #respond #submit:hover',
				'property' => 'border-color',
			),
		),
	);
	...
	$settings[] = array(
		...
		'control' => 'color',
		'label'   => __( 'Main content link color', 'good' ),
		'section' => 'content_colors',
		'priority' => 3,
		'apply_css' => array (
			array(
				'selector' => 'a, #primary .entry-title a:hover, #primary .nav-meta, #site-footer a',
				'property' => 'color',
			),
			array(
				'selector' => '#primary input[type="button"], #primary input[type="reset"], #primary input[type="submit"], #primary button, #primary .button, #primary .load-more a',
				'property' => 'background-color',
			),
		),
	);
	...
	$settings[] = array(
		...
		'control' => 'color',
		'label'   => __( 'Main content meta color', 'good' ),
		'section' => 'content_colors',
		'priority' => 4,
		'apply_css' => array (
			array(
				'selector' => '#primary .meta, #breadcrumbs, #respond .required-attr, #reply-title, #comments .commentlist li .meta, #comments .commentlist li .meta a, #breadcrumbs a:after',
				'property' => 'color',
			),
			array(
				'selector' => '.widget_nav_menu [class^="icon-"] a',
				'property' => 'border-color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['content_widget_title_color'],
		'transport' => 'postMessage',
		'id' => 'content_widget_title_color',
		'control' => 'color',
		'label'   => __( 'Main content widget title color', 'good' ),
		'section' => 'content_colors',
		'priority' => 5,
		'apply_css' => array (
			array(
				'selector' => '#primary .widget-title, #reply-title',
				'property' => 'color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['content_widget_title_border_color'],
		'transport' => 'postMessage',
		'id' => 'content_widget_title_border_color',
		'control' => 'color',
		'label'   => __( 'Main content widget title border color', 'good' ),
		'section' => 'content_colors',
		'priority' => 6,
		'apply_css' => array (
			array(
				'selector' => '#primary .widget-title:before, #reply-title:before',
				'property' => 'border-color',
			),
			array(
				'selector' => '#breadcrumbs, #site-footer:before',
				'property' => 'border-top-color',
			),
			array(
				'selector' => '.no-title',
	...
	$settings[] = array(
		...
		'control' => 'color',
		'label'   => __( 'Main content border color', 'good' ),
		'section' => 'content_colors',
		'priority' => 7,
		'apply_css' => array (
			array(
			...
			array(
				'selector' => '.page-navigation, .single-meta, .single-meta > div:nth-child(1), .single-meta > div:nth-child(2), #primary blockquote, #primary #searchform, #primary .posts-block .post .meta:before, #share-post li a, input[type=text], select, textarea, tr, th, td, table caption',
				'property' => 'border-color',
			),
			array(
				'selector' => '.single-meta div div:before',
				'property' => 'background-color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['content_container_border_color'],
		'transport' => 'postMessage',
		'id' => 'content_container_border_color',
		'control' => 'color',
		'label'   => __( 'Main content container border color', 'good' ),
		'section' => 'content_colors',
		'priority' => 8,
		'apply_css' => array (
			array(
				'selector' => '#main-content:before',
				'property' => 'border-color',
			),
		),
	);
	...
	/* Section : Secondary Sidebar Colors
	---------------------------------*/

	$settings[] = array(
		'default' => $default_color_options['secondary_sidebar_background_color'],
		'transport' => 'postMessage',
		'id' => 'secondary_sidebar_background_color',
		'control' => 'color',
		'label'   => __( 'Secondary sidebar background color', 'good' ),
		'section' => 'secondary_sidebar_colors',
		'priority' => 1,
		'apply_css' => array (
			array(
				'selector' => '#secondary',
	...
	$settings[] = array(
		'default' => $default_color_options['secondary_sidebar_color'],
		'transport' => 'postMessage',
		'id' => 'secondary_sidebar_color',
		'control' => 'color',
		'label'   => __( 'Secondary sidebar color', 'good' ),
		'section' => 'secondary_sidebar_colors',
		'priority' =>2,
		'apply_css' => array (
			array(
				'selector' => '#secondary, #secondary .entry-title, #secondary input[type=text], #secondary select, #secondary textarea',
				'property' => 'color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['secondary_sidebar_link_color'],
		'transport' => 'postMessage',
		'id' => 'secondary_sidebar_link_color',
		'control' => 'color',
		'label'   => __( 'Secondary sidebar link color', 'good' ),
		'section' => 'secondary_sidebar_colors',
		'priority' =>3,
		'apply_css' => array (
			array(
				'selector' => '#secondary a, #secondary .entry-title a:hover',
				'property' => 'color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['secondary_sidebar_meta_color'],
		'transport' => 'postMessage',
		'id' => 'secondary_sidebar_meta_color',
		'control' => 'color',
		'label'   => __( 'Secondary sidebar meta color', 'good' ),
		'section' => 'secondary_sidebar_colors',
		'priority' => 4,
		'apply_css' => array (
			array(
				'selector' => '#secondary .meta, #secondary .meta a, #secondary .widget-title',
				'property' => 'color',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['secondary_sidebar_border_color'],
		'transport' => 'postMessage',
		'id' => 'secondary_sidebar_border_color',
		'control' => 'color',
		'label'   => __( 'Secondary sidebar border color', 'good' ),
		'section' => 'secondary_sidebar_colors',
		'priority' => 45,
		'apply_css' => array (
			array(
				'selector' => '#secondary .widget, #secondary input[type=text], #secondary select, #secondary textarea, #secondary tr, #secondary th, #secondary td, #secondary table caption',
				'property' => 'border-color',
			),
		),
	);
	...
	$settings[] = array(
		...
		'id' => 'heading_font',
		'label'    => __( 'Heading font', 'good' ),
		'section'  => 'typography',
		'priority' => 1,
		'control'     => 'select',
		'choices'  => fancythemes_array_font(),
	);
	...
	$settings[] = array(
		...
		'apply_css' => array (
			array(
				'selector' => 'h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6, button, html input[type="button"], input[type="reset"], input[type="submit"], .page-navigation',
				'property' => 'font-style',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['heading_font_transform'],
		'transport' => 'postMessage',
		'id' => 'heading_font_transform',
		'section'  => 'typography',
		'priority' => 4,
		'control'     => 'select',
		'choices'  => array( 'none' => 'Text Transform', 'uppercase'=>'Uppercase', 'lowercase'=>'Lowercase', 'capitalize'=>'Capitalize' ),
		'apply_css' => array (
			array(
				'selector' => 'h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6, button, html input[type="button"], input[type="reset"], input[type="submit"], .page-navigation',
	...
	$settings[] = array(
		'default' => $default_color_options['meta_font'],
		'transport' => 'postMessage',
		'id' => 'meta_font',
		'label'    => __( 'Meta font', 'good' ),
		'section'  => 'typography',
		'priority' => 7,
		'control'     => 'select',
		'choices'  => fancythemes_array_font(),
	...
	$settings[] = array(
		'default' => $default_color_options['meta_font_style'],
		'transport' => 'postMessage',
		'id' => 'meta_font_style',
		'section'  => 'typography',
		'priority' => 8,
		...
		'apply_css' => array (
			array(
				'selector' => '.meta, .category-meta, #breadcrumbs, .comment-meta, .slider-view .nav-meta',
				'property' => 'font-style',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['meta_font_weight'],
		'transport' => 'postMessage',
		'id' => 'meta_font_weight',
		'section'  => 'typography',
		'priority' => 9,
	...
	$settings[] = array(
		...
		'apply_css' => array (
			array(
				'selector' => '#main-navigation > div > ul > li > a',
				'property' => 'font-style',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['menu_font_transform'],
		'transport' => 'postMessage',
	...
	$settings[] = array(
		'default' => $default_color_options['widget_title_font'],
		'id' => 'widget_title_font',
		'label'    => __( 'Wigdet title font', 'good' ),
		'section'  => 'typography',
		'priority' => 15,
		'control'     => 'select',
		'choices'  => fancythemes_array_font(),
	...
	$settings[] = array(
		'default' => $default_color_options['widget_title_font_style'],
		'transport' => 'postMessage',
		'id' => 'widget_title_font_style',
		'section'  => 'typography',
		'priority' => 16,
		'control'     => 'radio',
		'choices'  => array('italic'=>'Italic', 'normal'=>'Normal'),
		'apply_css' => array (
			array(
				'selector' => '#primary .widget-title, #secondary .widget-title, #reply-title',
				'property' => 'font-style',
			),
		),
	);
	...
	$settings[] = array(
		'default' => $default_color_options['widget_title_font_weight'],
		'transport' => 'postMessage',
	...
	$settings[] = array(
		'default' => $default_color_options['widget_title_font_transform'],
		'transport' => 'postMessage',
		'id' => 'widget_title_font_transform',
		'section'  => 'typography',
		'priority' => 18,
		'control'     => 'select',
		'choices'  => array( 'none' => 'Text Transform', 'uppercase'=>'Uppercase', 'lowercase'=>'Lowercase', 'capitalize'=>'Capitalize' ),
	...
	// Adding additional setting navigation option, the sticky menu.	
	$settings[] = array(
		'default' => false,
		'id' => 'primary_navigation_sticky',
		'label'    => __( 'Primary navigation sticky', 'good' ),
		'section'  => 'nav',
		'priority' => 20,
		'control'     => 'checkbox',
	);
	...
	$settings[] = array(
		'default' => false,
		'id' => 'secondary_navigation_sticky',
		'label'    => __( 'Secondary navigation sticky', 'good' ),
		'section'  => 'nav',
		'priority' => 21,
		'control'     => 'checkbox',
	);

	/* Section : Twitter OAuth setting
	---------------------------------*/

	$settings[] = array(
		'default' => '',
		'id' => 'twitter_consumer_key',
		'label'    => __( 'Consumer key', 'good' ),
		'section'  => 'twitter_oauth',
		'priority' => 21,
		'control'     => 'text',
	);
	...
	$settings[] = array(
		...
		'label'    => __( 'Access token secret', 'good' ),
		'section'  => 'twitter_oauth',
		'priority' => 24,
		'control'     => 'text',
	);
...
add_filter('customizer_wrapper_settings', 'fancythemes_customize_items' );
add_filter('apply_customizer_css', 'fancythemes_customize_items' );
add_filter('export_customizer_settings', 'fancythemes_customize_items' );
 ...
 */
function fancythemes_taxonomy_array( $taxonomy = 'category' ){
 ...
 */
function fancythemes_is_footer_background( $control ) {
 ...
 *
 */
function fancythemes_array_font(){
